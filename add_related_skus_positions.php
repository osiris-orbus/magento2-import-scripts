<?php
require("helpers.php");
$filename = './csv_files/related_positions.csv'; // csv file should only contain the columns 'sku' and 'related_product_sku'.
$file = fopen($filename, 'r');
$data = csvFileToArray($file);

$new_filename = './csv_files/Generate Related Positions/related_skus'. time() .'.csv';
